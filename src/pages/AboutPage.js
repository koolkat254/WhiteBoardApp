  ...
  return (
    ...
    <div className={styles.box}>
      ...
      <div className={styles.prg}>
        <p className={styles.prgdsg}>Welcome to our Whiteboard App! We were originally a school project that our teacher had assigned to us.</p>
        <p className={styles.prgdsg}>This Whiteboard allows people to take photos of their art and drawings on a whiteboard. You are them able
